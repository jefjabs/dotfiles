...
function __promptline_ps1 {
  ...
  # section "b" header
  slice_prefix="${b_bg}${sep}${b_fg}${b_bg}${space}" slice_suffix="$space${b_sep_fg}" slice_joiner="${b_fg}${b_bg}${alt_sep}${space}" slice_empty_prefix="${b_fg}${b_bg}"
  [ $is_prompt_empty -eq 1 ] && slice_prefix="$slice_empty_prefix"
  # section "b" slices
...
function __promptline {
  ...
  local a_fg="${wrap}38;5;39${end_wrap}"
  local a_bg=""
  local a_sep_fg="${wrap}38;5;39${end_wrap}"
  local b_fg="${wrap}38;5;39${end_wrap}"
  local b_bg=""
  local b_sep_fg="${wrap}38;5;39${end_wrap}"
  local c_fg="${wrap}38;5;39${end_wrap}"
  local c_bg=""
  local c_sep_fg="${wrap}38;5;39${end_wrap}"
  local warn_fg="${wrap}38;5;166${end_wrap}"
  local warn_bg=""
  local warn_sep_fg="${wrap}38;5;39${end_wrap}"
  local y_fg="${wrap}38;5;255${end_wrap}"
  local y_bg="$"
  local y_sep_fg="${wrap}38;5;39${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
